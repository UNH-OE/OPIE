...
for frame_num=2:1:frame_end-frame_start+1,				%For k from "Starting Frame" to "Ending Frame"
   ...
   [pitch(frame_num),roll(frame_num),yaw(frame_num)]=PRY(dot1_3d(frame_num,:),dot2_3d(frame_num,:),dot3_3d(frame_num,:));
	...
	B=drawbox(B,area1(1,2),dot1(frame_num-1,4),dot1(frame_num-1,3));
	B=drawbox(B,area2(1,2),dot2(frame_num-1,4),dot2(frame_num-1,3));
	B=drawbox(B,area3(1,2),dot3(frame_num-1,4),dot3(frame_num-1,3));
   ...
   subplot(2,2,3),plot3(dot1_3d(:,1),dot1_3d(:,2),dot1_3d(:,3),'y');
   h=gca;
   set(h,'Color',[.8 .8 .8]);
	hold on;
	axis('ij');
	plot3(dot2_3d(:,1),dot2_3d(:,2),dot2_3d(:,3),'r');
	plot3(dot3_3d(:,1),dot3_3d(:,2),dot3_3d(:,3),'c');
	plot3(point_track(:,1),point_track(:,2),point_track(:,3),'g');
	xlabel('X');
	ylabel('Y');
	zlabel('Z');
   ...
   subplot(2,2,4),plot3(dot1_3d(:,1),dot1_3d(:,2),dot1_3d(:,3),'y');
   h=gca;
   set(h,'Color',[.8 .8 .8]);
	hold on;
	axis('ij');
